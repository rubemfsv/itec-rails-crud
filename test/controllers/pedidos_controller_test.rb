...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { body: @pedido.body, title: @pedido.title, user_id: @pedido.user_id } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { body: @pedido.body, title: @pedido.title, user_id: @pedido.user_id } }
